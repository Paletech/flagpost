...
def test_delete_user_not_found(client, superuser_token_headers):
    response = client.delete(
        "/api/v1/users/b21706cd-df99-490f-aa4f-7efa418b1343", headers=superuser_token_headers
    )
...
def test_edit_user_not_found(client, test_db, superuser_token_headers):
    ...
    response = client.put(
        "/api/v1/users/b21706cd-df99-490f-aa4f-7efa418b1343", json=new_user, headers=superuser_token_headers
    )
    assert response.status_code == 404
...
def test_user_not_found(client, superuser_token_headers):
    response = client.get("/api/v1/users/b21706cd-df99-490f-aa4f-7efa418b1343", headers=superuser_token_headers)
    assert response.status_code == 404
